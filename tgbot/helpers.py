...
def get_list_of_weekdays_between_dates(start_date: datetime, end_date: datetime, week_day: int) -> list[datetime]:
...
def check_dates(now: datetime, lection_start_datetime: datetime) -> bool:
    for schedule_date in get_list_of_weekdays_between_dates(lection_start_datetime,
